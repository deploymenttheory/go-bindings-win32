...
// reentrant native callback moves this goroutine's stack (see outparam.go).
// If a compiler change ever lets this allocation stay on the stack, this
// test fails before any live flake does.
