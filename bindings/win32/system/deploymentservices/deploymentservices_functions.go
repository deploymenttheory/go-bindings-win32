...
var Procs = struct {
	PxeAsyncRecvDone                       *win32.Proc
	PxeDhcpAppendOption                    *win32.Proc
	PxeDhcpAppendOptionRaw                 *win32.Proc
	PxeDhcpGetOptionValue                  *win32.Proc
	PxeDhcpGetVendorOptionValue            *win32.Proc
	PxeDhcpInitialize                      *win32.Proc
	PxeDhcpIsValid                         *win32.Proc
	PxeDhcpv6AppendOption                  *win32.Proc
	PxeDhcpv6AppendOptionRaw               *win32.Proc
	PxeDhcpv6CreateRelayRepl               *win32.Proc
	PxeDhcpv6GetOptionValue                *win32.Proc
	PxeDhcpv6GetVendorOptionValue          *win32.Proc
	PxeDhcpv6Initialize                    *win32.Proc
	PxeDhcpv6IsValid                       *win32.Proc
	PxeDhcpv6ParseRelayForw                *win32.Proc
	PxeGetServerInfo                       *win32.Proc
	PxeGetServerInfoEx                     *win32.Proc
	PxePacketAllocate                      *win32.Proc
	PxePacketFree                          *win32.Proc
	PxeProviderEnumClose                   *win32.Proc
	PxeProviderEnumFirst                   *win32.Proc
	PxeProviderEnumNext                    *win32.Proc
	PxeProviderFreeInfo                    *win32.Proc
	PxeProviderQueryIndex                  *win32.Proc
	PxeProviderRegister                    *win32.Proc
	PxeProviderSetAttribute                *win32.Proc
	PxeProviderUnRegister                  *win32.Proc
	PxeRegisterCallback                    *win32.Proc
	PxeSendReply                           *win32.Proc
	PxeTrace                               *win32.Proc
	PxeTraceV                              *win32.Proc
	WdsBpAddOption                         *win32.Proc
	WdsBpCloseHandle                       *win32.Proc
	WdsBpGetOptionBuffer                   *win32.Proc
	WdsBpInitialize                        *win32.Proc
	WdsBpParseInitialize                   *win32.Proc
	WdsBpParseInitializev6                 *win32.Proc
	WdsBpQueryOption                       *win32.Proc
	WdsCliAuthorizeSession                 *win32.Proc
	WdsCliCancelTransfer                   *win32.Proc
	WdsCliClose                            *win32.Proc
	WdsCliCreateSession                    *win32.Proc
	WdsCliFindFirstImage                   *win32.Proc
	WdsCliFindNextImage                    *win32.Proc
	WdsCliFreeStringArray                  *win32.Proc
	WdsCliGetDriverQueryXml                *win32.Proc
	WdsCliGetEnumerationFlags              *win32.Proc
	WdsCliGetImageArchitecture             *win32.Proc
	WdsCliGetImageDescription              *win32.Proc
	WdsCliGetImageFiles                    *win32.Proc
	WdsCliGetImageGroup                    *win32.Proc
	WdsCliGetImageHalName                  *win32.Proc
	WdsCliGetImageHandleFromFindHandle     *win32.Proc
	WdsCliGetImageHandleFromTransferHandle *win32.Proc
	WdsCliGetImageIndex                    *win32.Proc
	WdsCliGetImageLanguage                 *win32.Proc
	WdsCliGetImageLanguages                *win32.Proc
	WdsCliGetImageLastModifiedTime         *win32.Proc
	WdsCliGetImageName                     *win32.Proc
	WdsCliGetImageNamespace                *win32.Proc
	WdsCliGetImageParameter                *win32.Proc
	WdsCliGetImagePath                     *win32.Proc
	WdsCliGetImageSize                     *win32.Proc
	WdsCliGetImageType                     *win32.Proc
	WdsCliGetImageVersion                  *win32.Proc
	WdsCliGetTransferSize                  *win32.Proc
	WdsCliInitializeLog                    *win32.Proc
	WdsCliLog                              *win32.Proc
	WdsCliObtainDriverPackages             *win32.Proc
	WdsCliObtainDriverPackagesEx           *win32.Proc
	WdsCliRegisterTrace                    *win32.Proc
	WdsCliSetTransferBufferSize            *win32.Proc
	WdsCliTransferFile                     *win32.Proc
	WdsCliTransferImage                    *win32.Proc
	WdsCliWaitForTransfer                  *win32.Proc
	WdsTransportClientAddRefBuffer         *win32.Proc
	WdsTransportClientCancelSession        *win32.Proc
	WdsTransportClientCancelSessionEx      *win32.Proc
	WdsTransportClientCloseSession         *win32.Proc
	WdsTransportClientCompleteReceive      *win32.Proc
	WdsTransportClientInitialize           *win32.Proc
	WdsTransportClientInitializeSession    *win32.Proc
	WdsTransportClientQueryStatus          *win32.Proc
	WdsTransportClientRegisterCallback     *win32.Proc
	WdsTransportClientReleaseBuffer        *win32.Proc
	WdsTransportClientShutdown             *win32.Proc
	WdsTransportClientStartSession         *win32.Proc
	WdsTransportClientWaitForCompletion    *win32.Proc
	WdsTransportServerAllocateBuffer       *win32.Proc
	WdsTransportServerCompleteRead         *win32.Proc
	WdsTransportServerFreeBuffer           *win32.Proc
	WdsTransportServerRegisterCallback     *win32.Proc
	WdsTransportServerTrace                *win32.Proc
	WdsTransportServerTraceV               *win32.Proc
}{
	PxeAsyncRecvDone:                       procPxeAsyncRecvDone,
	PxeDhcpAppendOption:                    procPxeDhcpAppendOption,
	PxeDhcpAppendOptionRaw:                 procPxeDhcpAppendOptionRaw,
	PxeDhcpGetOptionValue:                  procPxeDhcpGetOptionValue,
	PxeDhcpGetVendorOptionValue:            procPxeDhcpGetVendorOptionValue,
	PxeDhcpInitialize:                      procPxeDhcpInitialize,
	PxeDhcpIsValid:                         procPxeDhcpIsValid,
	PxeDhcpv6AppendOption:                  procPxeDhcpv6AppendOption,
	PxeDhcpv6AppendOptionRaw:               procPxeDhcpv6AppendOptionRaw,
	PxeDhcpv6CreateRelayRepl:               procPxeDhcpv6CreateRelayRepl,
	PxeDhcpv6GetOptionValue:                procPxeDhcpv6GetOptionValue,
	PxeDhcpv6GetVendorOptionValue:          procPxeDhcpv6GetVendorOptionValue,
	PxeDhcpv6Initialize:                    procPxeDhcpv6Initialize,
	PxeDhcpv6IsValid:                       procPxeDhcpv6IsValid,
	PxeDhcpv6ParseRelayForw:                procPxeDhcpv6ParseRelayForw,
	PxeGetServerInfo:                       procPxeGetServerInfo,
	PxeGetServerInfoEx:                     procPxeGetServerInfoEx,
	PxePacketAllocate:                      procPxePacketAllocate,
	PxePacketFree:                          procPxePacketFree,
	PxeProviderEnumClose:                   procPxeProviderEnumClose,
	PxeProviderEnumFirst:                   procPxeProviderEnumFirst,
	PxeProviderEnumNext:                    procPxeProviderEnumNext,
	PxeProviderFreeInfo:                    procPxeProviderFreeInfo,
	PxeProviderQueryIndex:                  procPxeProviderQueryIndex,
	PxeProviderRegister:                    procPxeProviderRegister,
	PxeProviderSetAttribute:                procPxeProviderSetAttribute,
	PxeProviderUnRegister:                  procPxeProviderUnRegister,
	PxeRegisterCallback:                    procPxeRegisterCallback,
	PxeSendReply:                           procPxeSendReply,
	PxeTrace:                               procPxeTrace,
	PxeTraceV:                              procPxeTraceV,
	WdsBpAddOption:                         procWdsBpAddOption,
	WdsBpCloseHandle:                       procWdsBpCloseHandle,
	WdsBpGetOptionBuffer:                   procWdsBpGetOptionBuffer,
	WdsBpInitialize:                        procWdsBpInitialize,
	WdsBpParseInitialize:                   procWdsBpParseInitialize,
	WdsBpParseInitializev6:                 procWdsBpParseInitializev6,
	WdsBpQueryOption:                       procWdsBpQueryOption,
	WdsCliAuthorizeSession:                 procWdsCliAuthorizeSession,
	WdsCliCancelTransfer:                   procWdsCliCancelTransfer,
	WdsCliClose:                            procWdsCliClose,
	WdsCliCreateSession:                    procWdsCliCreateSession,
	WdsCliFindFirstImage:                   procWdsCliFindFirstImage,
	WdsCliFindNextImage:                    procWdsCliFindNextImage,
	WdsCliFreeStringArray:                  procWdsCliFreeStringArray,
	WdsCliGetDriverQueryXml:                procWdsCliGetDriverQueryXml,
	WdsCliGetEnumerationFlags:              procWdsCliGetEnumerationFlags,
	WdsCliGetImageArchitecture:             procWdsCliGetImageArchitecture,
	WdsCliGetImageDescription:              procWdsCliGetImageDescription,
	WdsCliGetImageFiles:                    procWdsCliGetImageFiles,
	WdsCliGetImageGroup:                    procWdsCliGetImageGroup,
	WdsCliGetImageHalName:                  procWdsCliGetImageHalName,
	WdsCliGetImageHandleFromFindHandle:     procWdsCliGetImageHandleFromFindHandle,
	WdsCliGetImageHandleFromTransferHandle: procWdsCliGetImageHandleFromTransferHandle,
	WdsCliGetImageIndex:                    procWdsCliGetImageIndex,
	WdsCliGetImageLanguage:                 procWdsCliGetImageLanguage,
	WdsCliGetImageLanguages:                procWdsCliGetImageLanguages,
	WdsCliGetImageLastModifiedTime:         procWdsCliGetImageLastModifiedTime,
	WdsCliGetImageName:                     procWdsCliGetImageName,
	WdsCliGetImageNamespace:                procWdsCliGetImageNamespace,
	WdsCliGetImageParameter:                procWdsCliGetImageParameter,
	WdsCliGetImagePath:                     procWdsCliGetImagePath,
	WdsCliGetImageSize:                     procWdsCliGetImageSize,
	WdsCliGetImageType:                     procWdsCliGetImageType,
	WdsCliGetImageVersion:                  procWdsCliGetImageVersion,
	WdsCliGetTransferSize:                  procWdsCliGetTransferSize,
	WdsCliInitializeLog:                    procWdsCliInitializeLog,
	WdsCliLog:                              procWdsCliLog,
	WdsCliObtainDriverPackages:             procWdsCliObtainDriverPackages,
	WdsCliObtainDriverPackagesEx:           procWdsCliObtainDriverPackagesEx,
	WdsCliRegisterTrace:                    procWdsCliRegisterTrace,
	WdsCliSetTransferBufferSize:            procWdsCliSetTransferBufferSize,
	WdsCliTransferFile:                     procWdsCliTransferFile,
	WdsCliTransferImage:                    procWdsCliTransferImage,
	WdsCliWaitForTransfer:                  procWdsCliWaitForTransfer,
	WdsTransportClientAddRefBuffer:         procWdsTransportClientAddRefBuffer,
	WdsTransportClientCancelSession:        procWdsTransportClientCancelSession,
	WdsTransportClientCancelSessionEx:      procWdsTransportClientCancelSessionEx,
	WdsTransportClientCloseSession:         procWdsTransportClientCloseSession,
	WdsTransportClientCompleteReceive:      procWdsTransportClientCompleteReceive,
	WdsTransportClientInitialize:           procWdsTransportClientInitialize,
	WdsTransportClientInitializeSession:    procWdsTransportClientInitializeSession,
	WdsTransportClientQueryStatus:          procWdsTransportClientQueryStatus,
	WdsTransportClientRegisterCallback:     procWdsTransportClientRegisterCallback,
	WdsTransportClientReleaseBuffer:        procWdsTransportClientReleaseBuffer,
	WdsTransportClientShutdown:             procWdsTransportClientShutdown,
	WdsTransportClientStartSession:         procWdsTransportClientStartSession,
	WdsTransportClientWaitForCompletion:    procWdsTransportClientWaitForCompletion,
	WdsTransportServerAllocateBuffer:       procWdsTransportServerAllocateBuffer,
	WdsTransportServerCompleteRead:         procWdsTransportServerCompleteRead,
	WdsTransportServerFreeBuffer:           procWdsTransportServerFreeBuffer,
	WdsTransportServerRegisterCallback:     procWdsTransportServerRegisterCallback,
	WdsTransportServerTrace:                procWdsTransportServerTrace,
	WdsTransportServerTraceV:               procWdsTransportServerTraceV,
}
