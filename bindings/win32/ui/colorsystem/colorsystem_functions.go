...
var (
	...
	procColorProfileAddDisplayAssociation        = modmscms.NewProc("ColorProfileAddDisplayAssociation")
	procColorProfileGetDeviceCapabilities        = modmscms.NewProc("ColorProfileGetDeviceCapabilities")
	procColorProfileGetDisplayDefault            = modmscms.NewProc("ColorProfileGetDisplayDefault")
	procColorProfileGetDisplayList               = modmscms.NewProc("ColorProfileGetDisplayList")
	procColorProfileGetDisplayUserScope          = modmscms.NewProc("ColorProfileGetDisplayUserScope")
	procColorProfileRemoveDisplayAssociation     = modmscms.NewProc("ColorProfileRemoveDisplayAssociation")
	procColorProfileSetDisplayDefaultAssociation = modmscms.NewProc("ColorProfileSetDisplayDefaultAssociation")
...
// ColorProfileAddDisplayAssociation calls mscms!ColorProfileAddDisplayAssociation.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofileadddisplayassociation
func ColorProfileAddDisplayAssociation(scope WCS_PROFILE_MANAGEMENT_SCOPE, profileName string, targetAdapterID foundation.LUID, sourceID uint32, setAsDefault bool, associateAsAdvancedColor bool) error {
	_profileName := win32.UTF16Ptr(profileName)
	_setAsDefault := win32.Bool32(setAsDefault)
	_associateAsAdvancedColor := win32.Bool32(associateAsAdvancedColor)
	r1, _, _ := syscall.SyscallN(procColorProfileAddDisplayAssociation.Addr(), uintptr(scope), uintptr(unsafe.Pointer(_profileName)), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(_setAsDefault), uintptr(_associateAsAdvancedColor))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileGetDeviceCapabilities calls mscms!ColorProfileGetDeviceCapabilities.
func ColorProfileGetDeviceCapabilities(scope WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID foundation.LUID, sourceID uint32, capsType WCS_DEVICE_CAPABILITIES_TYPE, outputCapabilities unsafe.Pointer) error {
	r1, _, _ := syscall.SyscallN(procColorProfileGetDeviceCapabilities.Addr(), uintptr(scope), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(capsType), uintptr(unsafe.Pointer(outputCapabilities)))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileGetDisplayDefault calls mscms!ColorProfileGetDisplayDefault.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilegetdisplaydefault
func ColorProfileGetDisplayDefault(scope WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID foundation.LUID, sourceID uint32, profileType COLORPROFILETYPE, profileSubType COLORPROFILESUBTYPE, profileName *foundation.PWSTR) error {
	r1, _, _ := syscall.SyscallN(procColorProfileGetDisplayDefault.Addr(), uintptr(scope), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(profileType), uintptr(profileSubType), uintptr(unsafe.Pointer(profileName)))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileGetDisplayList calls mscms!ColorProfileGetDisplayList.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilegetdisplaylist
func ColorProfileGetDisplayList(scope WCS_PROFILE_MANAGEMENT_SCOPE, targetAdapterID foundation.LUID, sourceID uint32, profileList **foundation.PWSTR, profileCount *uint32) error {
	r1, _, _ := syscall.SyscallN(procColorProfileGetDisplayList.Addr(), uintptr(scope), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(unsafe.Pointer(profileList)), uintptr(unsafe.Pointer(profileCount)))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileGetDisplayUserScope calls mscms!ColorProfileGetDisplayUserScope.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilegetdisplayuserscope
func ColorProfileGetDisplayUserScope(targetAdapterID foundation.LUID, sourceID uint32, scope *WCS_PROFILE_MANAGEMENT_SCOPE) error {
	r1, _, _ := syscall.SyscallN(procColorProfileGetDisplayUserScope.Addr(), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(unsafe.Pointer(scope)))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileRemoveDisplayAssociation calls mscms!ColorProfileRemoveDisplayAssociation.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofileremovedisplayassociation
func ColorProfileRemoveDisplayAssociation(scope WCS_PROFILE_MANAGEMENT_SCOPE, profileName string, targetAdapterID foundation.LUID, sourceID uint32, dissociateAdvancedColor bool) error {
	_profileName := win32.UTF16Ptr(profileName)
	_dissociateAdvancedColor := win32.Bool32(dissociateAdvancedColor)
	r1, _, _ := syscall.SyscallN(procColorProfileRemoveDisplayAssociation.Addr(), uintptr(scope), uintptr(unsafe.Pointer(_profileName)), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID), uintptr(_dissociateAdvancedColor))
	return win32.ErrIfFailed(int32(r1))
}

// ColorProfileSetDisplayDefaultAssociation calls mscms!ColorProfileSetDisplayDefaultAssociation.
// https://learn.microsoft.com/windows/win32/api/icm/nf-icm-colorprofilesetdisplaydefaultassociation
func ColorProfileSetDisplayDefaultAssociation(scope WCS_PROFILE_MANAGEMENT_SCOPE, profileName string, profileType COLORPROFILETYPE, profileSubType COLORPROFILESUBTYPE, targetAdapterID foundation.LUID, sourceID uint32) error {
	_profileName := win32.UTF16Ptr(profileName)
	r1, _, _ := syscall.SyscallN(procColorProfileSetDisplayDefaultAssociation.Addr(), uintptr(scope), uintptr(unsafe.Pointer(_profileName)), uintptr(profileType), uintptr(profileSubType), uintptr(win32.StructArg(targetAdapterID)), uintptr(sourceID))
	return win32.ErrIfFailed(int32(r1))
}
