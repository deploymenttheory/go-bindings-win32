...
var Procs = struct {
	ImmAssociateContext        *win32.Proc
	ImmAssociateContextEx      *win32.Proc
	ImmConfigureIME            *win32.Proc
	ImmConfigureIMEA           *win32.Proc
	ImmCreateContext           *win32.Proc
	ImmCreateIMCC              *win32.Proc
	ImmCreateSoftKeyboard      *win32.Proc
	ImmDestroyContext          *win32.Proc
	ImmDestroyIMCC             *win32.Proc
	ImmDestroySoftKeyboard     *win32.Proc
	ImmDisableIME              *win32.Proc
	ImmDisableLegacyIME        *win32.Proc
	ImmDisableTextFrameService *win32.Proc
	ImmEnumInputContext        *win32.Proc
	ImmEnumRegisterWord        *win32.Proc
	ImmEnumRegisterWordA       *win32.Proc
	ImmEscape                  *win32.Proc
	ImmEscapeA                 *win32.Proc
	ImmGenerateMessage         *win32.Proc
	ImmGetCandidateList        *win32.Proc
	ImmGetCandidateListA       *win32.Proc
	ImmGetCandidateListCount   *win32.Proc
	ImmGetCandidateListCountA  *win32.Proc
	ImmGetCandidateWindow      *win32.Proc
	ImmGetCompositionFont      *win32.Proc
	ImmGetCompositionFontA     *win32.Proc
	ImmGetCompositionString    *win32.Proc
	ImmGetCompositionStringA   *win32.Proc
	ImmGetCompositionWindow    *win32.Proc
	ImmGetContext              *win32.Proc
	ImmGetConversionList       *win32.Proc
	ImmGetConversionListA      *win32.Proc
	ImmGetConversionStatus     *win32.Proc
	ImmGetDefaultIMEWnd        *win32.Proc
	ImmGetDescription          *win32.Proc
	ImmGetDescriptionA         *win32.Proc
	ImmGetGuideLine            *win32.Proc
	ImmGetGuideLineA           *win32.Proc
	ImmGetHotKey               *win32.Proc
	ImmGetIMCCLockCount        *win32.Proc
	ImmGetIMCCSize             *win32.Proc
	ImmGetIMCLockCount         *win32.Proc
	ImmGetIMEFileName          *win32.Proc
	ImmGetIMEFileNameA         *win32.Proc
	ImmGetImeMenuItems         *win32.Proc
	ImmGetImeMenuItemsA        *win32.Proc
	ImmGetOpenStatus           *win32.Proc
	ImmGetProperty             *win32.Proc
	ImmGetRegisterWordStyle    *win32.Proc
	ImmGetRegisterWordStyleA   *win32.Proc
	ImmGetStatusWindowPos      *win32.Proc
	ImmGetVirtualKey           *win32.Proc
	ImmInstallIME              *win32.Proc
	ImmInstallIMEA             *win32.Proc
	ImmIsIME                   *win32.Proc
	ImmIsUIMessage             *win32.Proc
	ImmIsUIMessageA            *win32.Proc
	ImmLockIMC                 *win32.Proc
	ImmLockIMCC                *win32.Proc
	ImmNotifyIME               *win32.Proc
	ImmReSizeIMCC              *win32.Proc
	ImmRegisterWord            *win32.Proc
	ImmRegisterWordA           *win32.Proc
	ImmReleaseContext          *win32.Proc
	ImmRequestMessage          *win32.Proc
	ImmRequestMessageA         *win32.Proc
	ImmSetCandidateWindow      *win32.Proc
	ImmSetCompositionFont      *win32.Proc
	ImmSetCompositionFontA     *win32.Proc
	ImmSetCompositionString    *win32.Proc
	ImmSetCompositionStringA   *win32.Proc
	ImmSetCompositionWindow    *win32.Proc
	ImmSetConversionStatus     *win32.Proc
	ImmSetHotKey               *win32.Proc
	ImmSetOpenStatus           *win32.Proc
	ImmSetStatusWindowPos      *win32.Proc
	ImmShowSoftKeyboard        *win32.Proc
	ImmSimulateHotKey          *win32.Proc
	ImmUnlockIMC               *win32.Proc
	ImmUnlockIMCC              *win32.Proc
	ImmUnregisterWord          *win32.Proc
	ImmUnregisterWordA         *win32.Proc
}{
	ImmAssociateContext:        procImmAssociateContext,
	ImmAssociateContextEx:      procImmAssociateContextEx,
	ImmConfigureIME:            procImmConfigureIME,
	ImmConfigureIMEA:           procImmConfigureIMEA,
	ImmCreateContext:           procImmCreateContext,
	ImmCreateIMCC:              procImmCreateIMCC,
	ImmCreateSoftKeyboard:      procImmCreateSoftKeyboard,
	ImmDestroyContext:          procImmDestroyContext,
	ImmDestroyIMCC:             procImmDestroyIMCC,
	ImmDestroySoftKeyboard:     procImmDestroySoftKeyboard,
	ImmDisableIME:              procImmDisableIME,
	ImmDisableLegacyIME:        procImmDisableLegacyIME,
	ImmDisableTextFrameService: procImmDisableTextFrameService,
	ImmEnumInputContext:        procImmEnumInputContext,
	ImmEnumRegisterWord:        procImmEnumRegisterWord,
	ImmEnumRegisterWordA:       procImmEnumRegisterWordA,
	ImmEscape:                  procImmEscape,
	ImmEscapeA:                 procImmEscapeA,
	ImmGenerateMessage:         procImmGenerateMessage,
	ImmGetCandidateList:        procImmGetCandidateList,
	ImmGetCandidateListA:       procImmGetCandidateListA,
	ImmGetCandidateListCount:   procImmGetCandidateListCount,
	ImmGetCandidateListCountA:  procImmGetCandidateListCountA,
	ImmGetCandidateWindow:      procImmGetCandidateWindow,
	ImmGetCompositionFont:      procImmGetCompositionFont,
	ImmGetCompositionFontA:     procImmGetCompositionFontA,
	ImmGetCompositionString:    procImmGetCompositionString,
	ImmGetCompositionStringA:   procImmGetCompositionStringA,
	ImmGetCompositionWindow:    procImmGetCompositionWindow,
	ImmGetContext:              procImmGetContext,
	ImmGetConversionList:       procImmGetConversionList,
	ImmGetConversionListA:      procImmGetConversionListA,
	ImmGetConversionStatus:     procImmGetConversionStatus,
	ImmGetDefaultIMEWnd:        procImmGetDefaultIMEWnd,
	ImmGetDescription:          procImmGetDescription,
	ImmGetDescriptionA:         procImmGetDescriptionA,
	ImmGetGuideLine:            procImmGetGuideLine,
	ImmGetGuideLineA:           procImmGetGuideLineA,
	ImmGetHotKey:               procImmGetHotKey,
	ImmGetIMCCLockCount:        procImmGetIMCCLockCount,
	ImmGetIMCCSize:             procImmGetIMCCSize,
	ImmGetIMCLockCount:         procImmGetIMCLockCount,
	ImmGetIMEFileName:          procImmGetIMEFileName,
	ImmGetIMEFileNameA:         procImmGetIMEFileNameA,
	ImmGetImeMenuItems:         procImmGetImeMenuItems,
	ImmGetImeMenuItemsA:        procImmGetImeMenuItemsA,
	ImmGetOpenStatus:           procImmGetOpenStatus,
	ImmGetProperty:             procImmGetProperty,
	ImmGetRegisterWordStyle:    procImmGetRegisterWordStyle,
	ImmGetRegisterWordStyleA:   procImmGetRegisterWordStyleA,
	ImmGetStatusWindowPos:      procImmGetStatusWindowPos,
	ImmGetVirtualKey:           procImmGetVirtualKey,
	ImmInstallIME:              procImmInstallIME,
	ImmInstallIMEA:             procImmInstallIMEA,
	ImmIsIME:                   procImmIsIME,
	ImmIsUIMessage:             procImmIsUIMessage,
	ImmIsUIMessageA:            procImmIsUIMessageA,
	ImmLockIMC:                 procImmLockIMC,
	ImmLockIMCC:                procImmLockIMCC,
	ImmNotifyIME:               procImmNotifyIME,
	ImmReSizeIMCC:              procImmReSizeIMCC,
	ImmRegisterWord:            procImmRegisterWord,
	ImmRegisterWordA:           procImmRegisterWordA,
	ImmReleaseContext:          procImmReleaseContext,
	ImmRequestMessage:          procImmRequestMessage,
	ImmRequestMessageA:         procImmRequestMessageA,
	ImmSetCandidateWindow:      procImmSetCandidateWindow,
	ImmSetCompositionFont:      procImmSetCompositionFont,
	ImmSetCompositionFontA:     procImmSetCompositionFontA,
	ImmSetCompositionString:    procImmSetCompositionString,
	ImmSetCompositionStringA:   procImmSetCompositionStringA,
	ImmSetCompositionWindow:    procImmSetCompositionWindow,
	ImmSetConversionStatus:     procImmSetConversionStatus,
	ImmSetHotKey:               procImmSetHotKey,
	ImmSetOpenStatus:           procImmSetOpenStatus,
	ImmSetStatusWindowPos:      procImmSetStatusWindowPos,
	ImmShowSoftKeyboard:        procImmShowSoftKeyboard,
	ImmSimulateHotKey:          procImmSimulateHotKey,
	ImmUnlockIMC:               procImmUnlockIMC,
	ImmUnlockIMCC:              procImmUnlockIMCC,
	ImmUnregisterWord:          procImmUnregisterWord,
	ImmUnregisterWordA:         procImmUnregisterWordA,
}
